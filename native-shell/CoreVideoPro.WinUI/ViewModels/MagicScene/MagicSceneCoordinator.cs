...
/// the host) â€” <see cref="EvaluateAutomationPolicy"/> runs on the UI thread exactly as before,
...
public sealed partial class MagicSceneCoordinator : ObservableObject
{
    ...
    /// (StudioViewModel.RefreshProductionReadouts) â€” a plain property (no change
    ...
    private void ToggleAutomation()
    {
        ...
        _host.CommandStatus = ProductionMode == ProductionMode.SetAndForget
            ...
            : "Manual mode â€” operator controls scenes";
    ...
    public string BuildAutoProductionReadout()
    {
        ...
        return auto.Confidence > 0
            ? $"Auto: {auto.Action} {auto.Confidence}% â€” {auto.Reason}"
            : auto.Reason;
    }
