...
public sealed partial class SceneCanvasLayerViewModel : ObservableObject
{
    ...
    public void ApplyRoute()
    {
            ...
            _showInputs.FirstOrDefault(slot => slot.SlotNumber == showInputSlotNumber) is { } showInput)
        {
            ...
            _route.CaptureDeviceId = showInput.Kind is ShowInputKind.Blackmagic or ShowInputKind.Aja or ShowInputKind.UvcWebcam or ShowInputKind.Screen or ShowInputKind.SrtIngest or ShowInputKind.Browser
