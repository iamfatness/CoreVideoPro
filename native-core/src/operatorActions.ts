...
export type MediaCoreOperatorActionInput = {
...
const severityRank: Record<MediaCoreOperatorAction["severity"], number> = {
  critical: 0,
  warning: 1,
  info: 2
};

export function buildOperatorActions(input: MediaCoreOperatorActionInput): MediaCoreOperatorAction[] {
  const actions: MediaCoreOperatorAction[] = [];
