...
The integrated real-window probe in docs/audio-meter-stability.md supersedes the separate windowless test executable. It exercises Loaded/Unloaded, timer teardown, control collection, mute changes and forced GC using the product App metadata. Windows CI runs this stronger probe. The September 14 evidence above remains historical; no universal crash-free claim is made.
