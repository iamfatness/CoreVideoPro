...
|---|---|
| [#615](https://github.com/iamfatness/CoreVideoPro/issues/615) | Owner requested investigation of PC-wide connectivity loss during RTMP streaming. Measured excessive packet traffic with TCP_NODELAY; coalescing reduced matched packet traffic by about 80% and passed a ten-minute transport soak. Full meeting and original outage acceptance remain open. |
