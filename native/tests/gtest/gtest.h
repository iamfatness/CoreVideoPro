...
#define ASSERT_EQ(left, right) ::testing::AssertionStream(((left) == (right)), __FILE__, __LINE__)
...
#define ASSERT_GE(left, right) ::testing::AssertionStream(((left) >= (right)), __FILE__, __LINE__)
